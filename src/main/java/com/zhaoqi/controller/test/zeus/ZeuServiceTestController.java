package com.zhaoqi.controller.test.zeus;

import javax.annotation.Resource;

import com.tts.component.webservice.ServiceCaller;
...
public class ZeuServiceTestController {
    ...
    public ResponseVo sayHiByServiceCaller(){
        ...
        try {
            response = serviceCaller.futureGet("dcp.getFeedback", helloRequest,ResponseVo.class).get();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return response;
